...
class OneWayStringProvider extends ProviderBase {
    dispose() {
        if (this._expObj != null) {
            crsbinding.expression.release(this._expObj);
            delete this._expObj;
...
function OnceProvider(element, context, property, value, ctxName = "context", parentId) {
    if (ctxName == "context") {
        setContext$1(element, context, property, value);
    }
    else {
...
function setContext$1(element, context, property, value) {
...
class ProcessProvider extends ProviderBase {
    constructor(element, context, property, value, ctxName, parentId) {
        super(element, context, property, value, ctxName, parentId);
...
class ForRadioProvider extends ProviderBase {
    dispose() {
